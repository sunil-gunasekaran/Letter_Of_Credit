...
Template["components_get_all_LOC_req"].events({
	...
	Meteor.call('getAllLocReq','http://localhost:8888/getAllLocReq',data,function(error, result){
...
Template['components_get_all_LOC_req'].helpers({
