...
Template["components_get_iss_BOL_req"].events({
	...
	Meteor.call('retriveIssBOLetails','http://localhost:8888/retriveIssBOLetails',data,function(error, result){
...
Template['components_get_iss_BOL_req'].helpers({
