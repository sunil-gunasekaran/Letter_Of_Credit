...
Template["components_get_iss_LOC_req"].events({
	...
	Meteor.call('getIssueLOC','http://localhost:8888/getIssueLOC',data,function(error, result){
...
Template['components_get_iss_LOC_req'].helpers({
